...
1. Check `{current_ux_agent_dialog_dir}/` for pending trigger mapping dialogs
...
- `{current_trigger_mapping_dir}/00-trigger-map.md`
- `{current_trigger_mapping_dir}/01-Business-Goals.md`
- `{current_trigger_mapping_dir}/02-*.md` persona documents
- `{current_trigger_mapping_dir}/05-Key-Insights.md`
- `{current_trigger_mapping_dir}/06-Feature-Impact.md` (optional)
