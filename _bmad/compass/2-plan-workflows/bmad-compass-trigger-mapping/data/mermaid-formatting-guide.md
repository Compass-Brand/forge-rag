...
**Required classes:**
```css
classDef primaryGoal fill:#facc15,color:#111827,stroke:#ca8a04,stroke-width:3px
...
- Primary goal: highlight color (#facc15) with darker border for the engine goal
- Secondary business goals: lightest gray (#f3f4f6)
