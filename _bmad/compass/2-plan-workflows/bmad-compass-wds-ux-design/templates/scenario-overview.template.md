...
**Target Personas:** {Which personas from trigger mapping use this scenario}
...
From trigger mapping analysis, this scenario serves these user goals:
...
**Scenario Folder:** `outline-scenarios/{scenario-number}-{scenario-name}/`
...
_Created using the Compass WDS planning lane_
