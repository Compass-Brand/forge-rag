...
2. Locate page specifications at `{current_conceptual_specifications_dir}/`
...
Save validation report to `{current_conceptual_specifications_dir}/validation-report.md`
