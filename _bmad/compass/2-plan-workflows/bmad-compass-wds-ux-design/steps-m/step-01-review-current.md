...
- Dependencies: Design system folder must exist at {current_conceptual_specifications_dir}/design-system/

## Sequence of Instructions (Do not deviate, skip, or optimize)

### 1. Load Design System

Check `{current_conceptual_specifications_dir}/design-system/` for existing components.
