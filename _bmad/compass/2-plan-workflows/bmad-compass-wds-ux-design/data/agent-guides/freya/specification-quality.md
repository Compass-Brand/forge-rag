...
**OBJECT IDs follow a consistent hierarchical pattern to identify UI locations across sketch, specification, and code.**
...
**Note:** OBJECT IDs become the shared locator key across sketch, specification, and code. When mirrored in implementation, they should align with `id` and any paired `aria-label` usage.
...
- **File Naming:** `../../FILE-NAMING-CONVENTIONS.md`
- **Language Config:** `../../language-configuration-guide.md`
