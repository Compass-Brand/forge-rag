...
- **SEO Content Instructions:** `../../../templates/instructions/seo-content.instructions.md` — Page-level SEO checklist during specification
...
- **Language Configuration:** `../../language-configuration-guide.md`
