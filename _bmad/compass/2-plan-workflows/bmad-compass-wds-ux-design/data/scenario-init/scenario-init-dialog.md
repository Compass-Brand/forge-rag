...
**Check**: Does `trigger-mapping/` folder exist?
...
**Agent creates**: `outline-scenarios/[Number]-[Name]/[Number]-[Name].md`
...
>
> **File**: `outline-scenarios/[Number]-[Name]/[Number]-[Name].md`
>
> **Next steps**:
...
**Actions**:
1. Read `trigger-mapping/[Trigger-Map-File].md` for each linked trigger
2. Add scenario link to each trigger's "How We Address This" or "Related Scenarios" section:
   ```markdown
   **Addressed in**: [Scenario 03: Booking Dog Walks](../outline-scenarios/03-Booking-Dog-Walks/03-Booking-Dog-Walks.md)
   ```
