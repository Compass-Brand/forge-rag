...
`{project-root}/_bmad/compass/1-analysis/bmad-compass-vtc-workshop/workflow.md`
...
`{current_outline_scenarios_dir}/[scenario-name]/vtc.yaml`

Example: `outline-scenarios/1.1-parent-onboarding/vtc.yaml`
