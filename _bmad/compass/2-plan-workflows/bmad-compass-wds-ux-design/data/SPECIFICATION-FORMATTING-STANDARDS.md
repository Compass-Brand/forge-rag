...
**Rules:**
- Always use `**OBJECT ID**:` (all caps, bold)
- Label in backticks
...
**Incorrect:**
```markdown
**Object ID**: signin-form-email  ← Not bold, no backticks
**object id**: `signin-form-email`  ← Not all caps
**OBJECT ID**: `SignIn-Form-Email`  ← CamelCase instead of kebab-case
```

**Note:** OBJECT IDs identify UI locations across sketch, specification, and code. They are the canonical traceability handle from spec to implementation.
...
### ❌ Mistake 2: Inconsistent OBJECT ID Format
...
- **Specification Quality Guide:** `./agent-guides/freya/specification-quality.md`
