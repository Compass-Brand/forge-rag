...
**Object ID Format:**
- [ ] Format: `**OBJECT ID**: `{label}`` (bold, all caps, backticks)
...
**Reference:** `./SPECIFICATION-FORMATTING-STANDARDS.md`
...
- [ ] Page purpose clear
- [ ] VTC reference present
- [ ] Structural OBJECT IDs complete
- [ ] Interactive OBJECT IDs complete
