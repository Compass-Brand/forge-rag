...
**File:** `{current_design_delivery_dir}/DD-XXX-name.yaml`
...
design_artifacts:
  scenarios:
    - id: '01-welcome'
      path: 'conceptual-specifications/01-welcome-screen/'
    - id: '02-login'
      path: 'conceptual-specifications/02-login/'
    # ... etc
...
**File:** `{current_design_delivery_test_dir}/TS-XXX-name.yaml`
  ...
  - id: 'HP-001'
    ...
    steps:
      - action: 'Open app'
        ...
        design_ref: 'conceptual-specifications/01-welcome/Frontend/specifications.md'
      # ... etc
```
...
**Protocol:** See `../data/handoff-dialog-scripts.md`
...
delivery:
  ...
  handoff_log: 'design-delivery/handoff/DD-001-handoff-log.md'
```
...
**Location:** `{current_design_delivery_dir}/DD-XXX-name.yaml`
...
**Location:** `{current_design_delivery_test_dir}/TS-XXX-name.yaml`
...
**Location:** `{current_design_delivery_handoff_dir}/DD-XXX-handoff-log.md`
