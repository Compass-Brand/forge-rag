...
📦 Artifacts:
- Design Delivery: {current_design_delivery_dir}/DD-XXX-name.yaml
- Test Scenario: {current_design_delivery_test_dir}/TS-XXX-name.yaml
- Scenario outlines: {current_outline_scenarios_dir}/ ([number] scenarios)
- Conceptual specs: {current_conceptual_specifications_dir}/
- Handoff Log: {current_design_delivery_handoff_dir}/DD-XXX-handoff-log.md
