...
- Design reference: conceptual-specifications/XX-name/
...
- Specs: conceptual-specifications/design-system/.../Buttons/

Input:
- Text variant: [Usage]
- Email variant: [Usage]
- Password variant: [Usage]
- Specs: conceptual-specifications/design-system/.../Inputs/
...
- You have all conceptual specs in conceptual-specifications/
- You have any supporting design notes linked from design-delivery/
