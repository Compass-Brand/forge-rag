...
- **UI mockups (page/section):** `{current_conceptual_specifications_dir}/design-system/01-visual-design/design-concepts/`
- **Image assets (photos/illustrations):** `{current_conceptual_specifications_dir}/design-system/01-visual-design/design-concepts/` (move to `02-assets/images/` when finalized)
- **Legacy path:** `{current_conceptual_specifications_dir}/[scenario]/visuals/` (if project uses older folder structure)
