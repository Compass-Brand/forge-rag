...
**File location:** `{current_ux_agent_dialog_dir}/`
...
1. Read the **page specification** from `{current_outline_scenarios_dir}/` (or equivalent)
2. Read the **visual direction** from `{current_product_brief_dir}/` (if available)
3. Read the **design system tokens** from `{current_conceptual_specifications_dir}/design-system/` (if available)
...
**Auto-detect sketches:** Check `{current_outline_scenarios_dir}/[scenario]/[page]/Sketches/` for hand-drawn wireframes. If found, offer to use as reference.
...
| `output_path` | `{current_conceptual_specifications_dir}/design-system/01-visual-design/design-concepts/` |
