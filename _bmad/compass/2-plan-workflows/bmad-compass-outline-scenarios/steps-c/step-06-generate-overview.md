...
Create `{current_outline_scenarios_dir}/00-ux-scenarios.md`
...
These scenario outlines feed into the next Compass design steps:
- `Create UX` for interaction framing
- `Conceptual Specifications` for implementation-ready page and flow specs
- `Design Delivery` for packaged handoff artifacts

---

_Generated with the Compass WDS planning lane_
```
