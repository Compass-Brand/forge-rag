...
### Files Created
- `outline-scenarios/00-ux-scenarios.md` — Scenario index
- `outline-scenarios/01-[slug]/01-[slug].md` — [Scenario name]
- `outline-scenarios/02-[slug]/02-[slug].md` — [Scenario name]
[list all...]
```
...
The next Compass design steps take each scenario outline forward:
- **Sketch** scenarios wait for your drawings
- **Create UX** scenarios start with collaborative interaction framing
- **Conceptualize** scenarios move into implementation-ready conceptual specs
- **Design Delivery** packages completed spec sets for implementation

You can always change approach before `Conceptual Specifications`.
