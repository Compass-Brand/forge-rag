...
- `current_product_brief_dir`, `current_trigger_mapping_dir`, `current_outline_scenarios_dir`, `current_ux_agent_dialog_dir`

### 2. Agent Dialog Gate

1. Check `{current_ux_agent_dialog_dir}/` for pending scenario dialogs
...
- `{current_outline_scenarios_dir}/00-ux-scenarios.md` — Scenario index with coverage matrix
- `{current_outline_scenarios_dir}/NN-[scenario-name]/NN-[scenario-name].md` — Individual scenario outlines
