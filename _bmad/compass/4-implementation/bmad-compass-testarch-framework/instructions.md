...
**Workflow ID**: `_bmad/compass/4-implementation/bmad-compass-testarch-framework`
...
`{project-root}/_bmad/compass/4-implementation/bmad-compass-testarch-framework/steps-c/step-01-preflight.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/_bmad/compass/4-implementation/bmad-compass-testarch-framework/steps-c/step-01b-resume.md`
