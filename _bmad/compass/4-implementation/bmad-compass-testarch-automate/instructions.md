...
**Workflow ID**: `_bmad/compass/4-implementation/bmad-compass-testarch-automate`
...
`{project-root}/_bmad/compass/4-implementation/bmad-compass-testarch-automate/steps-c/step-01-preflight-and-context.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/_bmad/compass/4-implementation/bmad-compass-testarch-automate/steps-c/step-01b-resume.md`
