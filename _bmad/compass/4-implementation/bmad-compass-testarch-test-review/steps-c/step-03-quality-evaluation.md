...
- Output: `{test_artifacts}/tmp/tea-test-review-determinism-${timestamp}.json`
- Status: Running in parallel... ⟳

**Subprocess B: Isolation**

- File: `./step-03b-subprocess-isolation.md`
- Output: `{test_artifacts}/tmp/tea-test-review-isolation-${timestamp}.json`
- Status: Running in parallel... ⟳

**Subprocess C: Maintainability**

- File: `./step-03c-subprocess-maintainability.md`
- Output: `{test_artifacts}/tmp/tea-test-review-maintainability-${timestamp}.json`
- Status: Running in parallel... ⟳

**Subprocess D: Performance**

- File: `./step-03e-subprocess-performance.md`
- Output: `{test_artifacts}/tmp/tea-test-review-performance-${timestamp}.json`
- Status: Running in parallel... ⟳
...
const outputs = ['determinism', 'isolation', 'maintainability', 'performance'].map(
  (dim) => `{test_artifacts}/tmp/tea-test-review-${dim}-${timestamp}.json`,
);
