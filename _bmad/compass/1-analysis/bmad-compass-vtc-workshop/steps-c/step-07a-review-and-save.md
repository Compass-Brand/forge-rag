...
**If Product Pitch:**
- Location: `{roadmap_product_brief_dir}/vtc-primary.yaml`
- Purpose: Stakeholder communication, strategic alignment

**If Scenario:**
- Location: `{current_outline_scenarios_dir}/[scenario-name]/vtc.yaml`
- Purpose: Guide scenario design decisions

**If Prototype/Other:**
- Location: `{current_ux_progress_dir}/vtc-[name].yaml`
