...
**Created:** 2026-01-08
**Module:** cybersec-team (Cybersecurity Operations)
...
**Output Location:** `{current_security_review_dir}/security-review-{project_name}.md`
...
1. Ensure cybersec-team module is installed
...
This workflow is part of the **cybersec-team** module. To install:
