...
# File References
nextStepFile: '{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-05-scope.md'
...
**Opening Exploration:**
"Now that we know who this repo or workflow serves and what problem it solves, let's define what success looks like.
...
"I've defined success metrics that will help us track whether this repo or workflow is creating real value and achieving its intended outcome.
