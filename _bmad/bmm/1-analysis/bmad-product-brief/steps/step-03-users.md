...
# File References
nextStepFile: '{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-04-metrics.md'
...
**Opening Exploration:**
"Now that we understand what this repo or product effort is for, let's define who it serves.
...
- "Tell me about a typical person who would use this repo or its resulting workflow"
...
- "Walk me through how [Persona Name] would discover and start using this repo or workflow"
...
"I've mapped out who this repo or workflow serves and how they'll interact with it.
