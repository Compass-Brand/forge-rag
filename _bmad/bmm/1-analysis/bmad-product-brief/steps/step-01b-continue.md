...
"Resuming the product brief workflow for the current target repo.
...
- If `lastStep = 1` → Load `{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-02-vision.md`
- If `lastStep = 2` → Load `{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-03-users.md`
- If `lastStep = 3` → Load `{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-04-metrics.md`
...
"The product brief workflow for the current target repo is already complete.
