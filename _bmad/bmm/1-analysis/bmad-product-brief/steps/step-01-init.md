...
# File References
nextStepFile: '{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-02-vision.md'
...
- ✅ Derive the target repo identity from the current `{project-root}` directory name for output reporting
...
- 🚫 Do not leak `compass-engine` into downstream file names, titles, or reports unless the current repo actually is `compass-engine`
...
- **STOP immediately** and load `{project-root}/_bmad/bmm/1-analysis/bmad-product-brief/steps/step-01b-continue.md`
...
"Product brief workspace initialized for the current target repo.
