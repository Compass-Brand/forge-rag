...
- Load: `{project-root}/_bmad/bmm/1-analysis/research/bmad-domain-research/domain-steps/step-02-domain-analysis.md`
...
After user selects 'C', load `{project-root}/_bmad/bmm/1-analysis/research/bmad-domain-research/domain-steps/step-02-domain-analysis.md` to begin industry analysis.
