...
- Load: `{project-root}/_bmad/bmm/1-analysis/research/bmad-technical-research/technical-steps/step-04-architectural-patterns.md`
...
After user selects 'C', load `{project-root}/_bmad/bmm/1-analysis/research/bmad-technical-research/technical-steps/step-04-architectural-patterns.md` to analyze architectural patterns, design decisions, and system structures for {{research_topic}}.
