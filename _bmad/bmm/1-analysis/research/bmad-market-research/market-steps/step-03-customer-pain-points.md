...
- Load: `{project-root}/_bmad/bmm/1-analysis/research/bmad-market-research/market-steps/step-04-customer-decisions.md`
...
After user selects 'C', load `{project-root}/_bmad/bmm/1-analysis/research/bmad-market-research/market-steps/step-04-customer-decisions.md` to analyze customer decision processes, journey mapping, and decision factors for {{research_topic}}.
