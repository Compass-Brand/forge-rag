...
# File References
nextStepFile: '{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-04-journeys.md'
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-04-journeys.md` to map user journeys.
