...
# File References
nextStepFile: '{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-07-project-type.md'
outputFile: '{current_prd_dir}/prd.md'

# Data Files
projectTypesCSV: '{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/data/project-types.csv'
