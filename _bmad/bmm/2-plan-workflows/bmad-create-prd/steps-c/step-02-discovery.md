...
# File References
nextStepFile: '{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-02b-vision.md'
...
- `projectContextHint` - Greenfield vs brownfield after filtering out scaffold-only docs
...
{{if projectContextHint == "brownfield"}}This is a brownfield project, so I'll focus on understanding what you want to add or change in an existing system.{{else}}This is a greenfield project. Scaffold-only docs do not change that, and I'll use any completed product brief as the primary input for the product vision.{{/if}}"
...
If this is a greenfield project with no completed product brief, start with open-ended discovery:
- What problem does this solve?
- Who's it for?
- What excites you about building this?

If a completed product brief exists, use it as the primary input and ask only the minimum clarifying questions needed to classify the project.
