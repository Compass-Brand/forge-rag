...
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-03-success.md`, read its frontmatter
- Read fully and follow: `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-prd/steps-c/step-04-journeys.md`

### 4. Handle Workflow Completion

**If `stepsCompleted` array contains `"step-12-complete.md"`:**
"It looks like the PRD workflow is already complete for this repo.
...
"Welcome back {{user_name}}. I'm resuming the PRD workflow for this repo.
**Current Progress:**
