...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current responsive/accessibility strategy
...
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.
