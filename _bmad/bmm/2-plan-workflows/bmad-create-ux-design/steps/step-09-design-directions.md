...
I'm creating a comprehensive HTML design direction showcase at `{current_ux_dir}/ux-design-directions.html`
...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current design direction content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current design direction
...
- Append the final content to `{current_ux_dir}/ux-design-specification.md`
- Update frontmatter: append step to end of stepsCompleted array
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-10-user-journeys.md` to design user journey flows.
