...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current design system content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current design system choice
...
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
