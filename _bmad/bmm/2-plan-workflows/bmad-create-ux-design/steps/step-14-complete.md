...
**The complete UX design specification is now available at:** `{current_ux_dir}/ux-design-specification.md`

**Supporting Visual Assets:**

- Color themes visualizer: `{current_ux_dir}/ux-color-themes.html`
- Design directions mockups: `{current_ux_dir}/ux-design-directions.html`
