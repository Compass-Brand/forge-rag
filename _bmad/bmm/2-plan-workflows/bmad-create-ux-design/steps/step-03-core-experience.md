...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current core experience content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current core experience definition
...
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.
