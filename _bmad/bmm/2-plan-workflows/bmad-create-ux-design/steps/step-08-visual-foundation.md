...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current visual foundation content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current visual foundation
...
- Load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-09-design-directions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-09-design-directions.md` to generate design direction mockups.
