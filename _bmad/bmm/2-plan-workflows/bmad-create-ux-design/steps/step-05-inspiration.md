...
- Read fully and follow: {project-root}/_bmad/core/bmad-advanced-elicitation/workflow.xml with the current inspiration analysis content
...
- Read fully and follow: {project-root}/_bmad/core/bmad-party-mode/workflow.md with the current inspiration analysis
...
- Read fully and follow: `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-06-design-system.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/bmm/2-plan-workflows/bmad-create-ux-design/steps/step-06-design-system.md` to choose the appropriate design system approach.
