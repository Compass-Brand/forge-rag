...
- Search `{current_prd_dir}` for files matching `*prd*.md`
- Also check for sharded PRDs: `{current_prd_dir}/**/*.md`
...
**If NO PRDs found:**
- "I couldn't find any PRD files in {current_prd_dir}. Please provide the path to the PRD file you want to validate."
