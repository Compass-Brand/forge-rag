...
Facilitator: "Perfect. Epic {{epic_number}} is complete and ready for retrospective, {user_name}."
</output>
</check>
...
Facilitator: "Total critical prep effort: {{critical_hours}} hours ({{critical_days}} days)"
...
Facilitator: "Alright team - great work today. We learned a lot from Epic {{epic_number}}. Let's use these insights to make Epic {{next_epic_num}} even better."
...
Facilitator: "Great session today, {user_name}. The team did excellent work."
