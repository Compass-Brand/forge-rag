...
- The `{project-root}/_bmad/core/module.yaml` framework will automatically:
...
- **Workflow variables**: From workflow.yaml (`current_story_dir`, `epics_file`, etc.)
...
3. **Load validation framework**: `{project-root}/_bmad/core/module.yaml`
4. **Extract metadata**: epic_num, story_num, story_key, story_title from story file
5. **Resolve all workflow variables**: `current_story_dir`, `epics_file`, `architecture_file`, etc.
