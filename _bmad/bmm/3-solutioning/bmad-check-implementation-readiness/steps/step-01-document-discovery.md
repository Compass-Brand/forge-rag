...
- Whole: `{current_prd_dir}/*.md`
- Sharded: `{current_prd_dir}/**/index.md` and related files

#### B. Architecture Documents

- Whole: `{current_architecture_dir}/*.md`
- Sharded: `{current_architecture_dir}/**/index.md` and related files

#### C. Epics & Stories Documents

- Whole: `{current_epics_dir}/*.md`
- Sharded: `{current_epics_dir}/**/index.md` and related files

#### D. UX Design Documents

- Whole: `{current_ux_dir}/*.md`
- Sharded: `{current_ux_dir}/**/index.md` and related files
