...
1. `{current_prd_dir}/*.md` (whole document)
2. `{current_prd_dir}/**/index.md` (sharded version)

**Architecture Document Search Priority:**

1. `{current_architecture_dir}/*.md` (whole document)
2. `{current_architecture_dir}/**/index.md` (sharded version)

**UX Design Document Search (Optional):**

1. `{current_ux_dir}/*.md` (whole document)
2. `{current_ux_dir}/**/index.md` (sharded version)
