...
- Look for `{current_architecture_dir}/architecture.md`
...
After user selects [C] to continue, load `{project-root}/_bmad/bmm/3-solutioning/bmad-generate-project-context/steps/step-02-generate.md` to collaboratively generate the specific project context rules.
