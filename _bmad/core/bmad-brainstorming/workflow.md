...
- `advancedElicitationTask` = the `bmad-advanced-elicitation` skill

### Routing Rule

- This workflow captures broad strategic brainstorming into roadmap lane.
- For implementation-focused ideation during active delivery, use `/bmad-bmm-implementation-brainstorming`.
